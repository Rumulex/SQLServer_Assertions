...
-- Display appropriate messages based on the existence of the manual columnIF EXISTS (
    SELECT 1
    FROM [dataedo_meta_upgrade_cs].[dbo].[columns] C
...
DECLARE @InflowId INT = 1035; -- Declare appropriate inflow_id from dbo.data_columns_flows appropriate to tested documentation
DECLARE @OutflowId INT = 1036; -- Declare appropriate outflow_id from dbo.data_columns_flows appropriate to tested documentation
